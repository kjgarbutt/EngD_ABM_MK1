...
class EngDParameters {
	...
	public static double TEMPORAL_RESOLUTION = 0.4;

	public static double WORLD_DISCRETIZTION = 0.1;

	public static double WALKING_SPEED = 5.1;

	public static String LSOA_SHP = "GloucestershireFinal_LSOA.shp";
	public static String BOUNDARY_SHP = "Gloucestershire_Boundary_Line.shp";

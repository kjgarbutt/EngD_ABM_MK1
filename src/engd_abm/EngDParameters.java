...
class EngDParameters {
	...
	// public static int NUM_ORIG_AGENTS = 1;
	// public static int NUM_ORIG_AGENTS = 7;
	public static int TRIALNO = 0;
	public static int TOTAL_POP = 14;
	// ----Agent Characteristic and Weights----//
	...
	public static String AGE_DIST = "age_dist2.csv";
	public static String POP_DIST = "pop_dist.csv";
	public static String FIN_DIST = "fin_dist.csv";
	...
	public static double convertFromKilometers(double val) {
		return (val * 1000.0)
				/ (EngDParameters.POP_BLOCK_METERS / EngDParameters.WORLD_TO_POP_SCALE);
	}

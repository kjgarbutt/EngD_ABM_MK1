...
public class EngDAStar {
	...
	public ArrayList<GeomPlanarGraphDirectedEdge> astarPath(Node start,
			Node goal) {
		...
		ArrayList<AStarNodeWrapper> closedSet = new ArrayList<AStarNodeWrapper>(), openSet = new ArrayList<AStarNodeWrapper>();
	...
	/**
	 * ///////////////////////////// Path Array
	 * ////////////////////////////////// Takes the information about the given
	 * node n and returns the path that found it.
	 * 
	 * @param n
	...
	/**
	 * /////////////////////////// Euclidean Distance
	 * //////////////////////////// Measure of the estimated distance between
	 * two Nodes. Extremely basic, just Euclidean distance as implemented here.
	 * 
	 * @param x
	 * @param y
	...
	/**
	 * //////////////////////// Nodes to Consider
	 * /////////////////////////////// Considers the list of Nodes open for
	 * consideration and returns the node with minimum fx value
	 * 
	 * @param set
	 *            list of open Nodes
	 * @return
	 ...
	 * 
	 * /////////////////////////// A* Node Meta Info
	 * ///////////////////////////// A wrapper to contain the A* meta
